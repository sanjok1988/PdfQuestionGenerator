...
(function(factory) {
  ...
  Checkboxpicker.prototype = {
    init: function() {
      ...
      this.$group.addClass(this.options.baseGroupCls).addClass(this.options
        .groupCls);
      ...
      if (this.options.offIconCls) {
        ...
        $.create('span').addClass(this.options.iconCls).addClass(this.options
          .offIconCls).prependTo(this.$off);
      }
    ...
    reset: function() {
      ...
      if ((this.element.defaultChecked && this.$off.hasClass('active')) ||
