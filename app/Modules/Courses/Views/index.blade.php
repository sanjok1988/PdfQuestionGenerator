			...
			<tbody>
				<tr v-for="(post, index) in posts">
					<td>@{{index+1}}</td>
						...
						<td><a :href="'{{url('chapters/')}}/' + post.course_code" title="Create Chapters">@{{post.course_name}}</a></td>
						...
						<td>
							...
							<a :href="'{{url('chapters/')}}/' + post.course_code" title="Create Chapters" class="btn btn-success btn-sm" ><i class="fa fa-plus"></i> List/Create Chapter</a>
