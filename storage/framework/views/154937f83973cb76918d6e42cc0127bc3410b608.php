...
<h3>FACULTY OF BUSINESS AND INIFORMATION CENTER</h3>
  <?php foreach($examDetails as $e): ?>
  <h3><?php echo e($e->exam_type ." ".$e->academic_year); ?></h3>
  <h3>Course Code And Name: <?php echo e($e->course_code); ?><?php echo e(" ".$course_name); ?></h3>
  <H3>Semester : <?php echo e($semester); ?></H3>
  <h5>Full Mark: <?php echo e($e->full_mark); ?></h5>
  <h5>Pass Mark: <?php echo e($e->pass_mark); ?></h5>
  <h5>Exam Date: <?php echo e($e->exam_date); ?></h5>
  <?php endforeach; ?>
  <hr>
  <br>
</div>
