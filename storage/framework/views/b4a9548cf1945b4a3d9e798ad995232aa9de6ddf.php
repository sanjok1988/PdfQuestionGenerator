<?php $__env->startSection('title','chapters | Lists'); ?>
...
<div class="x_content">
	<div id="posts">
		<h1><?php echo e($code); ?> chapters</h1><h1 v-cloak style="color:red">{{error}}</h1>
<hr>
<div class="row">
	<div class="col-md-12">
		<form id="create" method="POST" enctype="multipart/form-data" v-on:submit.prevent="store">
			...
			<div class="col-md-8">
				...
				<input type="hidden" name="course_code" value="<?php echo e($code); ?>">
				...
				<tr v-for="(post, index) in posts">
					<td>{{index+1}}</td>
						...
						<td>
							...
							<a :href="'<?php echo e(url('question/').'/'.$code); ?>/' +post.chapter_id" title="View or Create Questions" class="btn btn-success btn-sm" ><i class="fa fa-plus"></i> View/Create Questions</a>
...
// start app
var course_code = '<?php echo e($code); ?>';
var vm = new Vue({
	el: '#posts',
	data: {
		posts: [],
