<?php $__env->startSection('title','Exams | Lists'); ?>
				...
				<tr v-for="(post, index) in posts">
					<td>{{index+1}}</td>
						...
						<td>
							...
							<a :href="'<?php echo e(url('questions/generate/add?exam_id=')); ?>' + post.exam_id +'&semester='+post.semester+'&course_code='+post.course_code" title="Add Questions for this exam" class="btn btn-success btn-sm" ><i class="fa fa-plus"></i> Add Ques.</a>
<a :href="'<?php echo e(url('questions/generate/view?exam_id=')); ?>' + post.exam_id +'&semester='+post.semester+'&course_code='+post.course_code" title="Add Questions for this exam" class="btn btn-warning btn-sm" ><i class="fa fa-eye"></i> View Ques.</a>
<a :href="'<?php echo e(url('questions/generate/export?exam_id=')); ?>' + post.exam_id +'&semester='+post.semester+'&course_code='+post.course_code" title="Export PDF" class="btn btn-info btn-sm" ><i class="fa fa-file"></i> PDF</a>
