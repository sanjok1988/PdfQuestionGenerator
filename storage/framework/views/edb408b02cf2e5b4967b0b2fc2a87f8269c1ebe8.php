 <?php $__env->startSection('title','Users | Lists'); ?> <?php $__env->startSection('content'); ?>
<style>
    #role>ul>li {
        float: left;
        padding: 10px;
...
</div><?php $__env->stopSection(); ?> <?php $__env->startSection('styles'); ?> <?php $__env->stopSection(); ?> <?php $__env->startSection('scripts'); ?>
<script src="<?php echo e(url('vue/js/users.js')); ?>"></script>
