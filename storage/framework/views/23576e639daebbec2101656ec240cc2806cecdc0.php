...
<div class="x_content">
	...
	<div id="posts">
		...
		<h1>Questions : <?php echo e($code); ?> <?php echo e(App\Modules\Courses\Models\Courses::getCourseNameById($code)); ?> : chapter <?php echo e($cid); ?> : <?php echo e(App\Modules\Chapters\Models\Chapters::getChapterNameById($cid)); ?><span class="label label-warning ">  </span></h1>
			...
			<tbody>
				<tr v-for="(post, index) in posts">
					...
					<td v-cloak>
						...
						<?php /* <td v-cloak><div style="word-wrap: break-word">{{ post.chapter_id }}</div></td>
								...
								<form id="create" method="POST" enctype="multipart/form-data" v-on:submit.prevent="store">
									...
									<div class="col-md-8">
										<div class="form-group">
                                            ...
                                            <input  type="hidden"  name="chapter_id"  value="<?php echo e($cid); ?>" >
...
<?php $__env->startSection('styles'); ?>
	<?php echo e(HTML::style('admin/assets/sweetalert/sweetalert.css')); ?>

<?php $__env->stopSection(); ?>
<?php $__env->startSection('scripts'); ?>
	

	<?php echo e(HTML::script('plugins/ckeditor/ckeditor.js')); ?>


	<?php echo e(HTML::script('admin/assets/sweetalert/sweetalert.min.js')); ?>
...
var vm = new Vue({
    ...
    data: {
		...
		chapter_id : '<?php echo e($cid); ?>',
		course_code:'<?php echo e($code); ?>',
